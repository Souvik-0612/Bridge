...
\begin{tabular}{| p{9mm} | p{6mm} | p{9mm} | p{9mm} | p{30mm} | p{80mm} | p{62mm} | p{46mm} |}
	...
	\cellcolor[gray]{0.9} \textbf{OPEN} & \cellcolor[gray]{0.9} \textbf{ART} & \cellcolor[gray]{0.9} \textbf{MIN CRDS} & \cellcolor[gray]{0.9} \textbf{NEG. DBL} & \cellcolor[gray]{0.9} \textbf{DESCRIPTION} & \cellcolor[gray]{0.9} \textbf{RESPONSES} & \cellcolor[gray]{0.9} \textbf{SUBSEQUENT ACTION} & \cellcolor[gray]{0.9} \textbf{COMPETITIVE \& \cellcolor[gray]{0.9} PASSED HAND BIDDING} \\ \hline
        ...
        &{ \footnotesize After 1\C\ -2\C\ :  2NT= \H\ \S\ STP; 2x = x STP; 3y = STP ASK; 3\C\ =no STP ; 3NT = 18+, Similar after 1\C\ -2\D\ ;  4\C\ = INV,  4\C\ = KCB,  XYZ   \par }
	...
	1\D & &3 & 3\S\ &11-21, no 5cM. \D\ $>$ \C\ and not 3-3 in mm 
        ...
        &{\footnotesize After 1\D\ -2\D\ :  2NT= \H\ \S\ STP; 2x = x STP; 3y = STP ASK; 3\D\ =no STP ; 3NT = 18+, Similar after 1\D\ -3\C\ ;    4\D\ = KCB, XYZ \par }
        & 1\D-2\D\ and 1\D\ - 3\C\ NAT in COMP. 1\D-2\D = INV+ in 3rd/4th
        \\ \hline

        %major openings
	1\H & &5 & 3\S\ &11-21 
        &{\footnotesize 1/ \S\ / \S\ = 0-4 \S\  F1 6+PTS, 1NT $<=$12 pt, 5+ \S\,  2\C\ = FG NAT or BAL (SUPP), 2\D\ =FG 5+\D\ , 2\H\ = FG 5+ \H\ , 2\S\ =  8-10 3supp, 2NT= GF 3Supp, 3\C\ = 7-10 4supp, 3\D\ = 10-12 4supp, 3\H\ = PRE 4Supp, 3\S\ / 3NT/ 4\C\ / 4\D\ = SPL, 4\H\ = PRE 5supp, 4\S\ = KCB \par }
      ...
      After 1 \H\ - 3\D\ : show shortness ; After 1 \H\ -3\C\ : SS G/T; After 1\H\ - 3\D\ :  CUE, After 1\H\ - 2\H - 2way G/T. \par }
        ...
        \\ \hline
	1\S & & 5 & 3\S\ & 11-21  
        & {\footnotesize Same as 1 \H\ except: 1NT $<=$ 12 inc 3Supp, 2\H\ = FG 5+ \H\ , 2\S\ = 8-10 3supp, 3\S\ = PRE 4Supp, 3\H=SOL INV+, 4\S\ = PRE 5Supp, 4\H = SPL, 4NT = KCB \par }
      ...
      & Lebensohl (slow denies) (\ref{leb})\\ \hline
...
\begin{multicols}{2}
  ...
  \begin{itemize}
    ...
    \item 1NT-2\D\-2\H\-2\S\ = 5\H\ and 4\S\ , INV
  ...
  \label{2over1}
  \begin{itemize}
    \item 1\H\ - 2\D\ ,  1\S\ - 2\D\ and 1\S\-2\H\ = 5+ cards, FG. Then: 2NT = 6 cM, 2 M = waiting, REV=15+.
    ...
    \item 1\S\- 2\C\ - 3\D\ / \H\  or 1\S\ - 2\C\ - 3\D\ = SPL with \C\ 
    \end{itemize}
