...
\begin{multicols}{2}
  ...
  \end{itemize}
    \subsection{2-way Game tries (Kokish)}
  \label{twgt}
  \begin{itemize}
    \item After 1\S\ - 2\S\ or 1m-1\S\ - 2\S\, 3\C\, \D\, \H\ = SSGT, 2NT=HSGT (Resp shows first suit in which he will accept a GT)
    \item After 1\H\ - 2\H\ or 1m-1\S\ - 2\H\, 2NT, \D\, \H\ = SSGT, 2\S\ =HSGT (Resp shows first suit in which he will accept a GT, 2NT shows \S\ )
\end{itemize}
